...
This section covers the first task of this thesis project, which is the review of the literature on neuroevolution algorithms and benchmarks.
...
\begin{itemize}
    ...
    \item \textbf{IC2:} It is clear that the work is proposing a new neuroevolution algorithm or performing an evaluation of existing algorithms.
\end{itemize}
