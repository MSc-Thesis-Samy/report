...
cannot be classified correctly with a single decision line. \Cref{fig:na_twoquarters} shows the results of the $(1 + 1)$ NA algorithm on the \textit{TwoQuarters} benchmark, with a single or two neurons,
...
at a local optima with a fitness of $0.75$. % TODO Detail this?
...
Finally, the \texit{LocalOpt} problem requires three neurons to be solved. \Cref{fig:na_localopt} shows the results of the algorithm on this problem, with a fixed resolution of $400$, one, two
