...
Furthermore, for each of the algorithm, the most efficient configuration(s) were used to represent it in the comparison, where the efficiency is defined as a trade-off between the fitness
and the CPU time.
