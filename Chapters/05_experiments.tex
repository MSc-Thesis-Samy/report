...
Altogether, the CMA-ES algorithm appears as the most versatile and reliable algorithm, with good performance on all of the tested problems, coupled with its ease of use. The even simpler $(1 + 1)$ NA
