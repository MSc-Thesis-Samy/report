...
and the CPU time, with preference given to the fitness. For the NEAT and CMA-ES algorithms, the configurations can be found in \Cref{app:configurations}.
...
\Cref{fig:flowchart} shows a flow diagram representing the proposed strategy for the selection of the neuroevolution algorithm given the problem class.
